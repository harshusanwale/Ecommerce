...
<!-- Sidebar ================================================== -->
	<div id="sidebar" class="span3">
		<div class="well well-small"><a id="myCart" href="{{route('cart')}}"><img src="{{asset('')}}themes/images/ico-cart.png" alt="cart">3 Items in your cart  <span class="badge badge-warning pull-right">$155.00</span></a></div>
...
<!-- Sidebar end=============================================== -->
		<div class="span9">		
			...
			<div class="carousel-inner">
				@php $i = 0 ; @endphp
				@foreach($product->chunk(4) as $list)
			  ...
			  <ul class="thumbnails">
				...
				<li class="span3">
				  ...
				  <i class="tag"></i>
					...
					<div class="caption">
					  <h5>{{$value->name}}</h5>
					  <h4><a class="btn" href="{{route('product-details',$value->id)}}">VIEW</a> <span class="pull-right">${{$value->price}}</span></h4>
					</div>
				  </div>
				</li>
		...
		<h4>Latest Products </h4>
			  <ul class="thumbnails">
			  @foreach($letestproduct as $value)
				<li class="span3">
				  <div class="thumbnail">
					<a  href="{{route('product-details',$value->id)}}"><img src="{{asset('/upload').'/'.$value->image}}" alt=""/></a>
					<div class="caption">
					  <h5>{{$value->name}}</h5>
		                 <h4 style="text-align:center"><a class="btn" href="{{route('product-details',$value->id)}}"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">${{$value->price}}</a></h4>
					</div>
				  </div>
				</li>
				@endforeach
