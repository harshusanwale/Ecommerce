	...
	<table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
				  ...
				  <td>
					<div class="input-append"><input class="span1" style="max-width:34px" placeholder="1" id="appendedInputButtons" size="16" type="number" value="{{$cart->qty}}"> <button class="btn" type="button"><i class="icon-minus"></i></button><button class="btn" type="button"><i class="icon-plus"></i></button><button class="btn btn-danger btn-close" data-id="{{$cart->id}}" type="button"><i class="icon-remove icon-white"></i></button>				</div>
				  </td>
                ...
                <tr>
				 ...
				 <tr>
				  ...
				  <td>Pay with eway<input type="checkbox" name="eway" style=""></td>
                  <td class="label label-important buy-product" style="display:block"> <strong>Buy</strong></td>
                </tr>
				</tbody>
            </table>
