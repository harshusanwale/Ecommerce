                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('edit-category-post',$category->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" id="user_name" name="name" class="form-control col-md-7 col-xs-12" value="{{$category->name}}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <select name="parent_id" id="parent_id" class="form-control">
                          ...
                          <option value="{{$data->id}} "@if($category->category_id!=null && $category->category_id == $data->id) selected @endif>{{$data->name}}</option>
